...
export const services = [
  ...
  {
    id: 'reading',
    title: 'Хамтын Тарот уншлага',
    subtitle: 'Багц сонгоод видео уншлага үзнэ · Гишүүнчлэлд үнэгүй багтсан',
    priceDisplay: '15,000 ₮',
    price: 15000,
    period: '/сар',
    hue: 'var(--gold)',
    requiresBooking: false,
    features: [
      '3 багцаас өөрийнхөө багцыг сонгоно',
      'Видео уншлага + зураг, тайлбар',
      'Сэтгэгдэл үлдээж, бусадтай хуваалцана',
    ],
  },
  {
    id: 'tarot',
