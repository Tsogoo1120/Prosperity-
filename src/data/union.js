...
export const services = [
  {
    id: 'subscription',
    title: 'Subscription гишүүнчлэл',
    subtitle: 'Видео хичээл · Psychology тест · 31 өдрийн даалгавар',
    priceDisplay: '50,000 ₮',
    price: 50000,
    period: '/сар',
    hue: 'var(--primary)',
...
export const introVideo = {
  ...
  headline: 'Онлайн хичээл',
  description:
    'Энэ нь хувийн тарот уншлагаас тусдаа үйлчилгээ. Сар бүр шинэ видео хичээл, psychology тест, даалгавраар өөрийгөө илүү сайн таньж мэдэхэд зориулагдсан.',
  duration: '3:33',
  caption: 'Эхлээд танилцуулгыг үзээд өөрт тохирох эсэхийг мэдээрэй.',
  highlights: [
    'Spirituality, философийн сэдэвтэй видео хичээлүүд',
    'Community хэсэгт туршлагаа хуваалцах орон зай',
    '7 хоног бүр шинэ psychology тест',
  ],
}

export const instructor = {
  name: 'Хувийн тарот уншлага',
  role: '30 минут · Онлайн · 75,000 ₮',
  bio: 'Өөрт тохирох уншлагын төрлөө сонгоод надтай ганцаарчилж холбогдоно. Google Meet эсвэл Instagram-аар ярьж болно.',
}
