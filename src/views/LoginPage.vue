  ...
  <div class="login-page">
    <div class="login-card">
      ...
      <div class="login-body">
        <h1 class="login-title">Subscription нэвтрэх</h1>
        <p class="login-sub muted">
          Энэ хэсэг зөвхөн гишүүдэд зориулагдсан. Хувийн уншлага авахад нэвтрэх шаардлагагүй.
        </p>
        ...
        <button class="btn login-google-btn" :disabled="loading" @click="login">
          ...
          <span>Google хаягаараа нэвтрэх</span>
        </button>

        <div class="login-divider">
          <span class="muted" style="font-size: 13px">Subscription эрхгүй бол</span>
        </div>

        <button class="btn btn-ghost login-enroll-btn" @click="goEnrollSubscription">
          Subscription авах <UiIcon name="arrowRight" :size="16" />
        </button>
      </div>
